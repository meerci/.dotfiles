...
map("n", "<leader>bh", "<cmd>BufferLineMovePrev<cr>", { desc = "Move Buffer to Left" })
map("n", "<leader>bl", "<cmd>BufferLineMoveNext<cr>", { desc = "Move Buffer to Right" })
map("n", "<leader>bm", "<cmd>BufferLinePick<cr>", { desc = "Select Buffer" })
